...
HD_PWD='C:/SHS/Zynq7000AP_SoC_Ethernet_Packet_Redirection_Design/HW/nicap_extend/nicap_test.runs/bit_buffer_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_buffer_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_buffer_fifo.tcl
